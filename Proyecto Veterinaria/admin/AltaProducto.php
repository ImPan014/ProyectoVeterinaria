        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-5">
            <form action="../logica/productoControlador.php" method="post">
                <div class="row align-items-center mb-4 ">
                    ...
                    <div class="col-4">
                    <label for="inputId" class="col-form-label"><?php echo $id; ?></label>
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-4"></div>
                    <div class="col-2">
                        <label for="inputDescripcion" class="col-form-label">Imagen URL:</label>
                    </div>
                    <div class="col-4">
                        <input type="text" id="inputDescripcion" class="form-control" name="imageURL" required>
                    </div>
                    <div class="col-2"></div>
                </div>
                <div class="row align-items-center mb-4">
